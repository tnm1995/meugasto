...
export const firebaseConfig = {
  apiKey: getEnv("VITE_FIREBASE_API_KEY", "AIzaSyAGvFF-yczuGGYA6KJj-4O0Pcd7vOLyfdA"),
...
try {
  ...
  if (firebaseConfig.apiKey === "AIzaSyAGvFF-yczuGGYA6KJj-4O0Pcd7vOLyfdA" && typeof window !== 'undefined' && window.location.hostname === "localhost") {
  ...
  if (typeof window !== 'undefined') {
    try {
      ...
      const isFallbackKey = firebaseConfig.apiKey === "AIzaSyAGvFF-yczuGGYA6KJj-4O0Pcd7vOLyfdA";
